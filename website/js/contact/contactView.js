...
(function() {
    ...
    this.draw = function (params) {
        ...
        $('#screen').html(
            ...
            '           <h2 style="line-height: 1.25" class="col-xs-10">We service the Placer and Nevada County region (Roseville, Auburn, Colfax, Grass Valley, Nevada City, Lake of the Pines, etc). Please contact us with any questions you may have regarding our service.</h2>' +
